...
public class HeroController {
    ...
    private static final List<String> HEROES = List.of("Midoriya", "Guts", "Zoro", "Kakashi", "Goku");
    ...
    public String findByName(@PathVariable String name){
        return HEROES.stream().filter(n -> n.equalsIgnoreCase(name)).findFirst().orElse("not found");
    }
